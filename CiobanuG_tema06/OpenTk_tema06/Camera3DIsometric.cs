...
namespace ConsoleApp3
{
    class Camera3DIsometric
    {
        ...
        // Added clseEye and farEye
        private readonly Vector3 closeEye = new Vector3(100, 75, 25);
        private readonly Vector3 farEye = new Vector3(300, 275, 125);
